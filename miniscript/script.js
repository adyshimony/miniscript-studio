import init, { compile_unified, lift_to_miniscript, lift_to_policy, generate_address_for_network, get_taproot_leaves, get_taproot_branches, get_taproot_miniscript_branches } from './pkg/miniscript_wasm.js';
